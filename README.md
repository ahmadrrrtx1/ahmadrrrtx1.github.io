...
| P10 SEO/perf | sitemap, robots, canonical, JSON-LD (Person/WebSite/SoftwareSourceCode), OG images, Lighthouse-grade budgets: static HTML, 4.7 KB gz JS island, 96 KB latin-subset fonts self-hosted. Deployed 2026-09-01 to GitHub Pages (`ahmadrrrtx1/ahmadrrrtx1.github.io`, workflow build; SITE_URL baked in `.github/workflows/deploy.yml`). Next: Google Search Console verify + submit sitemap, optional custom domain via CNAME |
